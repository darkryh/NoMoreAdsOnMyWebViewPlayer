...
open class BlockerClient(
    ...
    @Deprecated("use onOverrideUrlLoading Instead", ReplaceWith("onOverrideUrlLoading(view, request)"))
     ...
     */
    @Deprecated("use onInterceptRequest Instead", ReplaceWith("onInterceptRequest(view, request)"))
